...
describe('Dollar', () => {
    it('should return 10 when five dollars are multiplied by two and 15 when multiple by three', () => {
    ...
    it('should return 10 when five euros are multiplied by two and 15 when multiple by three', () => {
